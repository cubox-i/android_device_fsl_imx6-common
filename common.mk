...
# prebuilts
PRODUCT_COPY_FILES += \
    $(COMMON_IMX)/rootdir/system/usr/keylayout/Dell_Dell_USB_Keyboard.kl:system/usr/keylayout/Dell_Dell_USB_Keyboard.kl \
    $(COMMON_IMX)/rootdir/system/usr/idc/Dell_Dell_USB_Keyboard.idc:system/usr/idc/Dell_Dell_USB_Keyboard.idc \
    $(COMMON_IMX)/rootdir/system/usr/idc/eGalax_Touch_Screen.idc:system/usr/idc/eGalax_Touch_Screen.idc \
    $(COMMON_IMX)/rootdir/system/usr/idc/eGalax_Touch_Screen.idc:system/usr/idc/HannStar_P1003_Touchscreen.idc \
    $(COMMON_IMX)/rootdir/system/usr/idc/eGalax_Touch_Screen.idc:system/usr/idc/Novatek_NT11003_Touch_Screen.idc \
    $(COMMON_IMX)/rootdir/system/etc/apns-conf.xml:system/etc/apns-conf.xml \
    $(COMMON_IMX)/rootdir/system/etc/ppp/init.gprs-pppd:system/etc/ppp/init.gprs-pppd \
    $(COMMON_IMX)/rootdir/system/etc/ota.conf:system/etc/ota.conf \
    $(COMMON_IMX)/rootdir/system/etc/display_mode_fb0.conf:system/etc/display_mode_fb0.conf \
    $(COMMON_IMX)/rootdir/system/etc/display_mode_fb2.conf:system/etc/display_mode_fb2.conf \
    $(COMMON_IMX)/rootdir/system/etc/display_mode_fb4.conf:system/etc/display_mode_fb4.conf
